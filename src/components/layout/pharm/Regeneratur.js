...
<p  className="py-2">Una ampolla contiene el equivalente a la vitamina C por aproximadamente 15 kilos de naranja.</p>
...
<div className="column">{IVimage}{content}</div>
<div className="column"><Video1  /></div>
</div>
</div>
